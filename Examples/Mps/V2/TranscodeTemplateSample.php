...
use Inspur\SDK\Mps\V2\Model\CreateTranscodeTemplateReq;
use Inspur\SDK\Mps\V2\Model\CreateTranscodeTemplateRequest;
use Inspur\SDK\Mps\V2\Model\GetTranscodeTemplateRequest;
use Inspur\SDK\Mps\V2\Model\DeleteTranscodeTemplateRequest;
use Inspur\SDK\Mps\V2\Model\ListTranscodeTemplateRequest;
use Inspur\SDK\Mps\V2\MpsClient;
use Inspur\SDK\Mps\V2\Enum\ContainerTypeEnum;
use Inspur\SDK\Mps\V2\Enum\VcodecEnum;
use Inspur\SDK\Mps\V2\Enum\FreqAudioEnum;
use Inspur\SDK\Mps\V2\Enum\AcodecEnum;
use Inspur\SDK\Mps\V2\Enum\ChannelsAudioEnum;
...
$body->setName('transcodeTemplate011');
...
if ($response->getBody()) {
    ...
    $requestGet->setId('69418539116350');//转码模板ID模糊查询，举例说明：699192
