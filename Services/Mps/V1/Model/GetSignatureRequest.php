...
class GetSignatureRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetSignatureRequest';
    ...
    */
    protected static $openAPITypes = [
            'body' => '\Inspur\SDK\Mps\V1\Model\GetSignatureReq'
    ];
